...
the precision of the fractional second. The default precision is 3 
(milliseconds).
...
specifies the precision of the fractional second. The default precision is 3 
(milliseconds).
...
altered. The lower-order time elements is unaltered.
...
[0, 86_400_000] altered. The lower-order time elements are truncated.
...
[0, 86_400_000_000] altered. The lower-order time elements are truncated.
...
Returns the difference between the instant of this time and the other in 
terms of hours. The result will be negative if the other time is before 
this time.
...
Returns the difference between the instant of this time and the other in 
terms of minutes. The result will be negative if the other time is before 
this time.
...
Returns the difference between the instant of this time and the other in 
terms of seconds. The result will be negative if the other time is before 
this time.
...
Returns the difference between the instant of this time and the other in 
terms of milliseconds. The result will be negative if the other time is 
before this time.
...
Returns the difference between the instant of this time and the other in 
terms of microseconds. The result will be negative if the other time is 
before this time.
...
Returns the difference between the instant of this time and the other in 
terms of nanoseconds. The result will be negative if the other time is 
before this time.
