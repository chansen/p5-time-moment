...
Returns a copy of this instance with the time zone set to UTC. Equivalent to:

    $tm2 = $tm1->with_offset(0);
...
Returns a copy of this instance with the given I<nanosecond> [0, 999_999_999] 
altered.
