...
0001-12-31T00. The fractional part corresponds to the fraction of the day 
after midnight.
...
Returns a copy of this instance with the time zone offset set to UTC.
...
date or time value or altering the components of the local date or time 
it may be necessary to use a time zone to convert to the correct 
representation. 
