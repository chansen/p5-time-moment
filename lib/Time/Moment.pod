...
The optional parameter I<precision> [-3, 9] specifies the precision of the
comparison. The default precision is 9 (nanoseconds). Please see 
L<with_precision|/with_precision> for an explanation of the precision value.
...
Copyright 2013-2016 by Christian Hansen.
