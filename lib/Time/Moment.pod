...
by a zone designator. The second part of the time of day may have a decimal 
fraction.
...
Replaced by the C locale's date representation. Equivalent to C<"%D">.

=item C<%X>

Replaced by the C locale's time representation. Equivalent to C<"%T">.
