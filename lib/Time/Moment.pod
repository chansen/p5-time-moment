...
The time zone Europe/Brussels has 01:00 UTC as standard time, and 02:00 UTC 
as daylight savings time, with transition dates according to the 
...
Sunday in March, in 2014 the date is March 30.

    $zone = DateTime::TimeZone->new(name => 'Europe/Brussels');
    $tm1  = Time::Moment->from_string('2014-03-29T12:00+01');
