...
if the constructor is invoked with I<seconds> only, fractional seconds is 
...
in terms of complete hours. The result will be negative if the time of the 
I<other> moment is before this time.
...
Returns the difference between the instant of this moment and the I<other> 
in terms of complete minutes. The result will be negative if the time of the 
I<other> moment is before this time.
...
Returns the difference between the instant of this time and the I<other> in 
terms of complete seconds. The result will be negative if the time of the 
I<other> moment is before this time.
...
Returns the difference between the instant of this time and the I<other> in 
terms of complete milliseconds. The result will be negative if the time of 
the I<other> moment is before this time.
...
Returns the difference between the instant of this time and the I<other> in 
terms of complete microseconds. The result will be negative if the time of 
the I<other> moment is before this time.
...
Returns the difference between the instant of this time and the I<other> in 
terms of complete nanoseconds. The result will be negative if the time of the 
I<other> moment is before this time.
...
greater than zero if this time is after the other time.
