...
specification permits use of a width where the default width of C<0> will 
...
The format string C<"%FT%T%f%Z"> can be used to create an equivalent string 
representation using C<strftime>.
