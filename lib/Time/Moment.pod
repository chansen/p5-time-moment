...
Returns a copy of this instance with the given I<day> of the month altered. 
...
Returns a copy of this instance with the given I<day> of the year altered. 
The day must be valid for the year, otherwise an exception is raised.
