...
have a decimal fraction. The decimal sign can be either the comma (C<,>) or 
the full stop (C<.>). A decimal fraction must have at least one digit and may
have a total of nine digits.
