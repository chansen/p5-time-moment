...
I<Please note that this conversion specification is an extension to the 
...
The C<$string> will be in one of the following formats:
...
The shortest representation will be used. This format is compatible with most 
