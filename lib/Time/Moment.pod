...
=head1 SYNOPSIS
    ...
    $days         = $tm->length_of_year;
    $days         = $tm->length_of_quarter;
...
Returns the length of the year in days [1, 366].

=head2 length_of_quarter

Returns the length of the quarter of the year in days [1, 92].

=head2 length_of_month

Returns the length of the month of the year in days [1, 31].
