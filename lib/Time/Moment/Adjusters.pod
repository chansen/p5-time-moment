...
=head2 NearestDayOfWeek

    $adjuster = NearestDayOfWeek($day);

The C<$adjuster> adjusts the date to the nearest occurrence of the given 
I<day> of the week [1=Monday, 7=Sunday].
