...
The C<$adjuster> adjusts the date to the Western Easter Sunday, the
time of the day is unaltered. The Western computus is based on the Gregorian 
calendar.
...
The C<$adjuster> adjusts the date to the Orthodox Easter Sunday, the
time of the day is unaltered. The Orthodox computus is based on the Julian 
calendar with the Julian date converted to the equivalent Gregorian date.
...
Given an interval of C<30> the outcome would be:
...
Copyright 2015 by Christian Hansen.
